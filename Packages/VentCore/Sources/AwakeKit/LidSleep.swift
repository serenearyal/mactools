...
/// is what `sudo pmset disablesleep 1` writes and what Vent's privileged
...
public enum LidSleepPolicy {
    ...
    public static let thermalCaption =
        "A closed Mac that cannot sleep gets hot in a bag, so Vent lets it sleep again "
            + "when this Mac reaches a serious thermal state."

    /// Whether Vent should be holding the flag at this instant.
    ///
    ...
    public var title: String {
        ...
        case (false, true):
            lidSleepIsOurs
                ...
                : "This Mac cannot sleep at all - set with pmset, not by Vent"
        case (false, false):
